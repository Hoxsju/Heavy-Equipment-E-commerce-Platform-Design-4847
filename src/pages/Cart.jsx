                  ...
                  {cartItems.map((item) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600">Part #: {item.partNumber || item.part_number}</p>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 sticky top-8">
              ...
              <div className="border-t pt-4 mb-6">
                ...
                <p className="text-sm text-gray-600 mt-2">
                  Pricing will be provided after submission based on your specific requirements.
                </p>
              </div>
